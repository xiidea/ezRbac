...
/* main styles */
	...
	/* buttons */
		...
		.btn_a{border:1px solid #c6c6c6;text-shadow: 1px 1px 0 #fff}
		.btn_a{font:700 12px/25px Helvetica, Arial, sans-serif}				
		.btn_a:hover{background:#e3e3e3}
	...
	/* alert boxes */
		.msg_box {padding:8px 20px 8px 20px;margin-bottom:10px;position:relative;color:#444;overflow:hidden}
		.msg_error {background:#f2cac2 ;border:1px solid #ae432e}
	
	/* forms */
		.formEl_a input{background:#fff;font-family:Helvetica, Arial, sans-serif;font-size:13px}
		.formEl_a input:focus,.formEl_a input:active{background:#ebfdd7}
	...
	.btn,.btn span {display:-moz-inline-stack;display:inline-block;zoom: 1;*display:inline}
	
	
	/* login page */
		.login_wrapper {width:372px;margin:0 auto;padding:180px 0 0;}
...
/* css3 enhance */
	...
	/* css3 gradients */
	.loginBox .heading {background: #ececec;background: -moz-linear-gradient(top, #f9f9f9 0%, #ececec 100%);background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#f9f9f9), color-stop(100%,#ececec));background: -webkit-linear-gradient(top, #f9f9f9 0%,#ececec 100%);background: -o-linear-gradient(top, #f9f9f9 0%,#ececec 100%)}
	
	
	/* css3 box shadow */
	.loginBox {-webkit-box-shadow: 0px 0px 4px 1px #ddd;-moz-box-shadow: 0px 0px 4px 1px #ddd;box-shadow: 0px 0px 4px 1px #ddd}
</style>
				...
				<div class="login_panes formEl_a">
					<div id="log_in_div">
						...
						<form action="" method="post" class="formEl sepH_c" id="form_login">
							...
							<div class="sepH_a">
								...
								<input type="text" id="username" name="username" class="inpt_a" value="<?php echo $this->input->post('username') ?>" />
							...
							<div class="sepH_b">
								<input type="checkbox" class="inpt_c" id="remember" name="remember" <?php if($this->input->post('remember')) echo 'checked="checked" '?>/>
					...
					<div id="get_password_div" style="display:none">
						...
						<form method="post" class="formEl sepH_c" name="frm_recover">
							<div class="sepH_b">
								<label for="user_email" class="lbl_a"> E-mail:</label>
